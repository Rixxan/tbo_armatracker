...
async def format_server_embeds(tbo):
    ...
    server_embed.set_thumbnail(
        url="https://static.wixstatic.com/media/5474d8_6521e7baef3545a8a8c91b8a55726f7d~mv2.png/"
...
@bot.command()
async def create_check(ctx):
    """Begin the looping check!"""
    tbo, players = await get_server_info()

    server_embed = await format_server_embeds(tbo)
